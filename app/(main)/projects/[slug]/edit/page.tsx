...
import { useProjectDetail, useProjectMutations } from "@/hooks/useProject";
...
export default function EditProjectPage() {
  ...
  const { data: project, isPending } = useProjectDetail(params.slug);
        ...
        <Form {...form}>
          ...
          >
            ...
            <Button
              type='submit'
              disabled={
                createFileMutation.isPending || updateProjectMutation.isPending
              }
            >
              {createFileMutation.isPending || updateProjectMutation.isPending
                ? "Submiting.."
